 ...
 * @Description: 
 * @Author: vivi
 * @Date: 2023-03-29 18:12:00
 * @LastEditTime: 2023-04-26 11:41:54
-->
<template>
  <page-meta :page-style="pageStyle" />
  <!-- ↓ 自定义导航 -->
  <set-nav-bar title="圈子" :back="false" :filter="false" :bg="true" />

  <!-- 未登录 -->
  <view class="un-login-wrapper fixed-top fixed-bottom" v-if="!isLogin">
    <set-un-login />
  </view>

  <!-- 已登录 -->
  <view class="login-wrapper fixed-top fixed-bottom" v-if="isLogin">
